...
- **Tap:** Jump
- **Space key:** Jump (desktop fallback)
- **H key:** Toggle hitbox debug (desktop only)

## ✨ Features

- **Conway's Game of Life Aesthetics**
  - PNG sprite player (200×200px run animation)
...
- **Mobile-Optimized**
  - Simple touch controls (tap to jump)
...
│   └── GameBaseConfig.js
├── assets/
│   └── dino-sprites/       # 2 PNG sprites (10 KB)
│       ├── run_0.png
│       └── run_1.png
└── README.md
```
...
- **Obstacles:** Ground-only GoL patterns (still lifes and oscillators)
  - BLOCK, BEEHIVE, LOAF, BOAT, TUB (static)
  - BLINKER, TOAD, BEACON (static rendering)
...
Useful for tuning collision detection.
